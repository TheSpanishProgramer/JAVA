...
// además se añade la mejora de poder comparar dos arrays directamente con Arrays.equals

import java.io.*;
import java.util.Arrays;

public class Ejer4_mejoradobis {
	...
	public static void main (String args[]) {
		...
		try {
			...
			if (tamano1 != tamano2) {
				...
				boolean mismos_vectores = Arrays.equals (vector1, vector2);
				
				while (leidos1 > 0 && leidos2 > 0 &&  mismos_vectores) 	{					
					leidos1 = buffer1.read(vector1);
					leidos2 = buffer2.read(vector2);
					mismos_vectores = Arrays.equals (vector1, vector2);
				}							
