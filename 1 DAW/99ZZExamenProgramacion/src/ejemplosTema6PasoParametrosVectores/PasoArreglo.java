package ejemplosTema6PasoParametrosVectores;
...
public class PasoArreglo 
{
   ...
   // E: arreglo2 => vector de enteros
   // S: nada, multiplica cada elemento del vector por 2 
   ...
   // E: elemento => un número entero
   // S: nada, intenta modificar elemento multiplicando elemento por 2 
