...
public class Prueba_Figura2 {	
	...
	public static void leer_figura_MAL (Figura fig) {
		...
		do {
			num = utilidades.teclado.leer_entero("\n Introduce el tipo de figura a introducir: 1 Cuadrado, 2 Circulo, 3 Triangulo, 4 Esfera, 5 Cubo:");
		} while (num <= 0 || num > 5);
		
		
		// datos comunes a todas las figuras
		String nomb = utilidades.teclado.leer_cadena ("\nNombre de la figura: ");
		int color2 = utilidades.teclado.leer_entero (", color: ");
		int grosor = utilidades.teclado.leer_entero (", grosor: ");
		
		if (num == 1)  {
			// Cuadrado			
			double lado_cuadrado = utilidades.teclado.leer_double (", lado del cuadrado: ");						
		...
		if (num == 2)  {
			// Circulo			
			double radio2 = utilidades.teclado.leer_double (", radio del círculo: ");						
		...
		if (num == 3)  {
			// Triangulo			
			double l1 = utilidades.teclado.leer_double (", lado1: ");
			double l2 = utilidades.teclado.leer_double (", lado2: ");
			double b = utilidades.teclado.leer_double (", base: ");
			double a = utilidades.teclado.leer_double (", altura: ");								
		...
		if (num == 4)  {
			// Esfera			
			double r = utilidades.teclado.leer_double (", radio de la esfera: ");						
		...
		if (num == 5)  {
			// Cubo			
			double lado_cubo = utilidades.teclado.leer_double (", lado del cubo: ");						
