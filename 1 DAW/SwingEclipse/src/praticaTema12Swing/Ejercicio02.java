...
public class Ejercicio02 {
	...
	private static void borrar() {
		String matricula = teclado.leer_cadena2("Introduzca la matrícula a borrar: ").toUpperCase();
	...
	private static void insertar() {
		String matricula = teclado.leer_cadena2("Introduzca la matrícula: ").toUpperCase();
		String marca = teclado.leer_cadena2("Introduzca la marca: ");
		String modelo = teclado.leer_cadena2("Introduzca el modelo: ");
		String color = teclado.leer_cadena2("Introduzca el color: ");
		int ano = teclado.leer_entero("Introduzca el año: ", 1900, 2050);
		int precio = teclado.leer_entero("Introduzca el precio: ", 0, Integer.MAX_VALUE);
	...
	private static int elegirOpcionMenu() {
		return teclado.leer_entero("Lee opción (1.."+opciones.length+"): ", 1, opciones.length);
	}
