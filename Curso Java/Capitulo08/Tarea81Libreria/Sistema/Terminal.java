 ...
 * de entrada/salida
 * Esta versión forma parte del paquete Sistema
 * @version 4.00 
...
public class Terminal {
   ...
   /**
    * Funciones mnemotécnicas para abreviar los métodos
    * de escritura
    *   iM: imprimeMensaje
    *   nL: nuevaLinea
    *   iMnL: imprimeMensajes + nuevaLinea
    */
   ...
   public static void iMnL (String mensaje) {
        imprimeMensaje(mensaje);
        imprimeMensaje();
   }
